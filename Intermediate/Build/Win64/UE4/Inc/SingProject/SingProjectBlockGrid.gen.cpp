...
// End Cross Module References
	...
	DEFINE_FUNCTION(ASingProjectBlockGrid::execVaRestResponse)
	{
	...
	void ASingProjectBlockGrid::StaticRegisterNativesASingProjectBlockGrid()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "VaRestResponse", &ASingProjectBlockGrid::execVaRestResponse },
		};
	...
	struct Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics
	{
		struct SingProjectBlockGrid_eventVaRestResponse_Parms
		{
			FString VaRestValue;
		};
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::NewProp_VaRestValue = { "VaRestValue", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SingProjectBlockGrid_eventVaRestResponse_Parms, VaRestValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::NewProp_VaRestValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::Function_MetaDataParams[] = {
		{ "Category", "VaRestResponse" },
		{ "ModuleRelativePath", "SingProjectBlockGrid.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASingProjectBlockGrid, nullptr, "VaRestResponse", nullptr, nullptr, sizeof(SingProjectBlockGrid_eventVaRestResponse_Parms), Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASingProjectBlockGrid_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ASingProjectBlockGrid_VaRestResponse, "VaRestResponse" }, // 4244269657
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ASingProjectBlockGrid, 346464630);
