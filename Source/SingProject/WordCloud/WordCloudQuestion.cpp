...
// Sets default values
AWordCloudQuestion::AWordCloudQuestion()
{
...
void AWordCloudQuestion::PassTimelineDownToCenter(float value)
{
...
void AWordCloudQuestion::ResetAll()
{
...
void AWordCloudQuestion::SetMaterialColorText(bool isEverbodySing)
{
	if(isEverbodySing)
	{
...
void AWordCloudQuestion::StartAnimateLineFinish()
{
	//GEngine->AddOnScreenDebugMessage(-1, 1.0f, FColor::Green, TEXT("TEXT"));
	OwningGrid->FinishLine();
}

void AWordCloudQuestion::StartAnimateOutLineFinish()
{
//	OwningGrid->FinishLineOut();
}


void AWordCloudQuestion::PassTimelineCenterToTop(float value)
{
...
void AWordCloudQuestion::SetToBaseMaterial()
{
		TextLine1->SetFrontMaterial(BaseMaterial);
		TextLine2->SetFrontMaterial(BaseMaterial);
}
...
void AWordCloudQuestion::SetToGlowMaterial()
{
...
void AWordCloudQuestion::SetValue(FString strQuestion1, FString strQuestion2) //FString strUrl, float floatSize
{
...
void AWordCloudQuestion::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AWordCloudQuestion::Tick(float DeltaTime)
{
